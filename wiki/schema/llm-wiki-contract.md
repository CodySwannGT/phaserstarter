# Collector — Game Docs Wiki — LLM Wiki Contract

> Generated by the `lisa-wiki` plugin from `wiki/lisa-wiki.config.json`.
> kernelVersion: 2.183.0 · schemaVersion: 1.0.0 · rendered: 2026-06-27
...
## What this is
A git-native markdown knowledge base under `wiki/`, owned by **Collector**, maintained by the
